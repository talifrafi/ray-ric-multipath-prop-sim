% Initialization
sampleRate1 = 500e3; % Sample rate of 500K Hz
sampleRate2  = 20e3; % Sample rate of 20K Hz
...
% Wideband or Freqeuncy-Selevtive Fading
...
release(rayChan);
rayChan.Visualization = 'Impulse and frequency responses';
rayChan.SampleRate = sampleRate2;
...
release(rayChan);
release(constDiag);
rayChan.SampleRate = sampleRate1;
